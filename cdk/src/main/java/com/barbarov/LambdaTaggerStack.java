 ...
 */
class LambdaTaggerStack extends Stack {
    public LambdaTaggerStack(final Construct parent, final String name) {
        super(parent, name);
        ...
        Function getOneItemFunction = new Function(this, "getOneItemFunction",
                getLambdaFunctionProps(lambdaEnvMap, "com.barbarov.lambda.GetOneItem"));
        Function getAllItemsFunction = new Function(this, "getAllItemsFunction",
                getLambdaFunctionProps(lambdaEnvMap, "com.barbarov.lambda.GetAllItems"));
        Function createItemFunction = new Function(this, "createItemFunction",
                getLambdaFunctionProps(lambdaEnvMap, "com.barbarov.lambda.CreateItem"));
        Function updateItemFunction = new Function(this, "updateItemFunction",
                getLambdaFunctionProps(lambdaEnvMap, "com.barbarov.lambda.UpdateItem"));
        Function deleteItemFunction = new Function(this, "deleteItemFunction",
                getLambdaFunctionProps(lambdaEnvMap, "com.barbarov.lambda.DeleteItem"));
    ...
    private FunctionProps getLambdaFunctionProps(Map<String, String> lambdaEnvMap, String handler) {
        return FunctionProps.builder()
                    .code(Code.fromAsset("./target/lambda-tagger-1.0.0-jar-with-dependencies.jar"))
                    .handler(handler)
